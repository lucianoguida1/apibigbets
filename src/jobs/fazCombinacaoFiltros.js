        ...
        try {
            ...
            for (let i = 0; i < total; i++) {
                ...
                if (i % 50 === 0 || i === (total - 1)) {
                    ...
                    await job.progress(Number(percent));
                }
            }
            await job.progress(100);
        } catch (error) {
            logTo('Erro ao executar as combinações de filtro jogos: ' + error.message, true, true);
        }
    }
}